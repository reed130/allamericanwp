...
(function($){
    ...
    $.fn.extend({
        ...
        venobox: function(options) {
          ...
          var defaults = {
              ...
              overlayColor : 'rgba(109, 110, 113, 0.9)',
          ...
          var option = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.on('click', function(e){
                    ...
                    vbheader = '<div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-close">x</div>';
    ...
    */
    ...
    function updateoverlay(){
      ...
      content.find(">:first-child").addClass('figlio').wrap('<div class="viewImage"></div>');
